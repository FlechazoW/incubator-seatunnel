...
/** A JDBC outputFormat */
public class MySQLOutputFormat<I, E extends JdbcBatchStatementExecutor<I>> implements Serializable {
    ...
    private transient Map<TableIdentifier, E> jdbcStatementExecutorMap;
    ...
    public MySQLOutputFormat(
        ...
        this.jdbcStatementExecutorMap = new HashMap<>();
    }
        ...
        if (jdbcConnectionConfig.getBatchIntervalMs() != 0
            ...
            this.scheduledFuture =
                    this.scheduler.scheduleWithFixedDelay(
                            () -> {
                                synchronized (MySQLOutputFormat.this) {
                                    if (!closed) {
                                        try {
                                            flush();
                                        } catch (Exception e) {
