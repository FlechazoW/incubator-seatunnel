...
public class MySQLOutputFormatBuilder {
    ...
    public MySQLOutputFormat<SeaTunnelRow, JdbcBatchStatementExecutor<SeaTunnelRow>> build(CatalogTable catalogTable) {
        MySQLOutputFormat.StatementExecutorFactory<JdbcBatchStatementExecutor<SeaTunnelRow>> statementExecutorFactory;

        TableIdentifier tableId = catalogTable.getTableId();

        final String database = tableId.getDatabaseName();
        final String table = tableId.getTableName();
    ...
    public static JdbcBatchStatementExecutor<SeaTunnelRow> createUpsertBufferedExecutor(
            JdbcDialect dialect,
            String database,
            String table,
