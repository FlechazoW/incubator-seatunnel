...
public class MySQLSinkFactory
        implements TableSinkFactory<SeaTunnelRow, MySQLSinkState, MySQLCommitInfo, MySQLCommitInfo>,
...
//                .conditional(GENERATE_SINK_SQL, false, QUERY)
    ...
    @Override
    public TableSink<SeaTunnelRow, MySQLSinkState, MySQLCommitInfo, MySQLCommitInfo> createSink(
